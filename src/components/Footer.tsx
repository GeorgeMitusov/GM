...
export default function Footer() {
  ...
  return (
    <footer className="w-full h-3/4 sm:h-5/6 md:h-full lg:h-auto xl:h-screen
       bg-mainColor flex flex-col justify-between items-center 
      ">
      <div 
        className="h-16 sm:h-20 w-full mdMobile:w-4/5 lgMobile:w-3/4 md:w-3/5 lg:w-2/4 xl:w-2/5
          flex justify-around mdMobile:justify-between sm:justify-around md:justify-between items-center 
          lg:mb-24 
        "
      ...
      ">
        <h1
          ...
          className="uppercase transition-all ease-in-out duration-700 
            ...
            lg:text-custom16 xl:text-custom13 2xl:text-custom15 3xl:text-custom155 4xl:text-custom17
